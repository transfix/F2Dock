...
// ─────────────────────────────────────────────── Per documentation §4.2.4, the
// output format has these columns: rank score shape ssr ccr scr elec hbond
// hydrophobicity smplcomp vdw clashes pgsol pgsolh deldispe mat1..mat12 conf
// rmsd
//
...
// ── Reranking fields
// ─────────────────────────────────────────────────────────── Per documentation
// §5, GB-rerank produces a reranked score
