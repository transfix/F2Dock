...
void tripep_closure::solve_3pep_poly(double r_n1[3], double r_a1[3],
...
//!-----------------------------------------------------------------------
// subroutine initialize_loop_closure(b_len, b_ang, t_ang)
void tripep_closure::initialize_loop_closure(double b_len[6], double b_ang[7],
                                             double t_ang[2]) {
  //!-----------------------------------------------------------------------
...
void tripep_closure::get_input_angles(int *n_soln, double r_n1[3],
                                      double r_a1[3], double r_a3[3],
                                      double r_c3[3]) {
  //!-----------------------------------------------------------------------
...
void tripep_closure::test_two_cone_existence_soln(double tt, double kx,
                                                  double et, double ap,
                                                  int *n_soln,
                                                  char cone_type[2]) {
  //  implicit none
...
void tripep_closure::poly_mul_sub2(double u1[5][5], double u2[5][5],
                                   double u3[5][5], double u4[5][5], int p1[2],
                                   int p2[2], int p3[2], int p4[2],
...
void tripep_closure::poly_mul2(double u1[5][5], double u2[5][5], int p1[2],
                               int p2[2], double u3[5][5], int p3[2]) {
  //  implicit none
...
void tripep_closure::poly_sub2(double u1[5][5], double u2[5][5], int p1[2],
                               int p2[2], double u3[5][5], int p3[2]) {
  //  implicit none
  //  real(dp), dimension(0:4,0:4), intent(in) :: u1, u2
...
void tripep_closure::poly_mul_sub1(double u1[17], double u2[17], double u3[17],
                                   double u4[17], int p1, int p2, int p3,
                                   int p4, double u5[17], int *p5) {
  //  implicit none
...
void tripep_closure::poly_mul1(double u1[17], double u2[17], int p1, int p2,
                               double u3[17], int *p3) {
  //  implicit none
...
void tripep_closure::poly_sub1(double u1[17], double u2[17], int p1, int p2,
                               double u3[17], int *p3) {
  //  implicit none
  //  real(dp), dimension(0:16), intent(in) :: u1, u2
  //  integer, intent(in) :: p1, p2
...
// r_soln_n, r_soln_a, r_soln_c)
void tripep_closure::coord_from_poly_roots(int *n_soln, double roots[max_soln],
  ...
  for (i_soln = 0; i_soln < *n_soln; i_soln++) {
    ...
    //     cos_tau[2], cos_tau[3]); printf("sin: %7.3f%7.3f%7.3f%7.3f\n",
    //     sin_tau[0], sin_tau[1], sin_tau[2], sin_tau[3]); do i = 1, 3
    //        j = i - 1
    ...
    if (print_level > 0) {
      ...
      //        write(*,"('alpha1, alpha3 = ', 2f9.3)") (kPi-a3a1a2)*kRad2Deg,
      //        (kPi-a2a3a1)*kRad2Deg
      ...
      //        write(*,"('ang_nac = ', 2f9.3)") b_ang0(1)*kRad2Deg,
      //        n1a1c1*kRad2Deg
      printf("ang_nac = %9.3f%9.3f\n", b_ang0[0] * kRad2Deg, n1a1c1 * kRad2Deg);
      //        write(*,"('ang_nac = ', 2f9.3)") b_ang0(4)*kRad2Deg,
      //        n2a2c2*kRad2Deg
      printf("ang_nac = %9.3f%9.3f\n", b_ang0[3] * kRad2Deg, n2a2c2 * kRad2Deg);
      //        write(*,"('ang_nac = ', 2f9.3)") b_ang0(7)*kRad2Deg,
      //        n3a3c3*kRad2Deg
      ...
      //        write(*,"('t_ang1 = ', 2f9.3)") t_ang0(1)*kRad2Deg,
      //        a1c1n2a2*kRad2Deg
      printf("t_ang1 = %9.3f%9.3f\n", t_ang0[0] * kRad2Deg,
             a1c1n2a2 * kRad2Deg);
      //        write(*,"('t_ang2 = ', 2f9.3)") t_ang0(2)*kRad2Deg,
      //        a2c2n3a3*kRad2Deg
...
void tripep_closure::calc_dih_ang(double r1[3], double r2[3], double r3[3],
                                  double *angle) {
  //!-----------------------------------------------------------------------
...
void tripep_closure::quaternion(double axis[3], double quarter_ang,
                                double p[4]) {
  //!-----------------------------------------------------------------------
