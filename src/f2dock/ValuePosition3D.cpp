...
/*                                                                  */
/********************************************************************/
ValuePosition3D::ValuePosition3D() { reset(); }
...
void ValuePosition3D::reset(void) {
  m_Value = -100000000.0;
  m_SkinSkinRealValue = -100000000.0, m_CoreCoreRealValue = -100000000.0,
  m_SkinCoreRealValue = -100000000.0;
  m_SkinSkinImaginaryValue = -100000000.0,
  m_CoreCoreImaginaryValue = -100000000.0,
  m_SkinCoreImaginaryValue = -100000000.0;
