...
public:
  ...
  void execute(XmlRpcValue &params, XmlRpcValue &result) {
    ...
    if (string(params[0]).compare("false")) // receptor PDB
    {
      ...
      if (!file)
        cout << "Failed to create file: " << dockJob->receptorPDBName.c_str()
             << endl;
    ...
    if (string(params[2]).compare("false")) // ligand PDB
    {
      ...
      if (!file)
        cout << "Failed to create file: " << dockJob->ligandPDBName.c_str()
             << endl;
      else {
    ...
    if (string(params[4]).compare("false")) // receptor PQR
    {
      ...
      if (!file)
        cout << "Failed to create file: " << dockJob->receptorPQRName.c_str()
             << endl;
      else {
    ...
    if (string(params[6]).compare("false")) // ligand PQR
    {
      ...
      if (!file)
        cout << "Failed to create file: " << dockJob->ligandPQRName.c_str()
             << endl;
      else {
    ...
    if (string(params[8]).compare("false")) // receptor F2D
    {
      ...
      if (!file)
        cout << "Failed to create file: " << dockJob->receptorF2dName.c_str()
             << endl;
      else {
    ...
    if (string(params[10]).compare("false")) // ligand F2D
    {
      ...
      if (!file)
        cout << "Failed to create file: " << dockJob->ligandF2dName.c_str()
             << endl;
      else {
    ...
    if (string(params[12]).compare("false")) // receptor RAWN
    {
      ...
      if (!file)
        cout << "Failed to create file: " << dockJob->receptorRAWNName.c_str()
             << endl;
      else {
    ...
    if (string(params[14]).compare("false")) // ligand RAWN
    {
      ...
      if (!file)
        cout << "Failed to create file: " << dockJob->ligandRAWNName.c_str()
             << endl;
      else {
    ...
    if (string(params[16]).compare("false")) // receptor QUAD
    {
      ...
      if (!file)
        cout << "Failed to create file: " << dockJob->receptorQuadName.c_str()
             << endl;
      else {
    ...
    if (string(params[18]).compare("false")) // ligand QUAD
    {
      ...
      if (!file)
        cout << "Failed to create file: " << dockJob->ligandQuadName.c_str()
             << endl;
      else {
    ...
    if (string(params[20]).compare("false")) // Docking Input
    {
      ...
      if (!file)
        cout << "Failed to create file: "
             << dockJob->dockingInputFileName.c_str() << endl;
      else {
    ...
    if (string(params[22]).compare("false")) // Reranking Input
    {
      ...
      if (!file)
        cout << "Failed to create file: "
             << dockJob->rerankingInputFileName.c_str() << endl;
      else {
    ...
    if (string(params[24]).compare("false")) // F2dGen Input
    {
      ...
      if (!file)
        cout << "Failed to create file: "
             << dockJob->f2dGenInputFileName.c_str() << endl;
      else {
    ...
    if (string(params[26]).compare("false")) // QuadGen Input
    {
      ...
      if (!file)
        cout << "Failed to create file: "
             << dockJob->quadGenInputFileName.c_str() << endl;
      else {
    ...
    if (string(params[28]).compare("false")) // RMSD
    {
      ...
      if (!file)
        cout << "Failed to create file: " << dockJob->rmsdFileName.c_str()
             << endl;
      else {
    ...
    if (string(params[30]).compare("false")) // Docking Output
    {
      ...
      if (!file)
        cout << "Failed to create file: "
             << dockJob->dockingOutputFileName.c_str() << endl;
      else {
    ...
    if (string(params[32]).compare("false")) // Reranking Output
    {
      ...
      if (!file)
        cout << "Failed to create file: "
             << dockJob->rerankingOutputFileName.c_str() << endl;
      else {
...
int main(int argc, char *argv[]) {
  if (argc != 3) {
    std::cerr << "Usage: F2DockServer serverPort platform(0 = standalone "
                 "linux, 1 = prism2, ...)\n";
    return -1;
  }
