...
// enum HBondProp;  /* properties related to hydrogen bonding -> defined in
// hbond.c */
...
struct atom {
  ...
  int sa;     /**< solvent accessible: 1 => solvent accessible, 0 => !1, -1 =>
                 undefined */
  ...
  /**< this should have been "enum HBondProp hprop" (HbondProp is defined in
   * hbond.h) */
  ...
  int hybridization; /**< hybridization state of the hydrogen bond acceptor atom
                      */
  /**< this should have been "enum HybridizationState hybridization"
   * (HybridizationState is defined in hbond.h) */
  /**< but C/C++ standard does not seem to allow forward decelarations */
  int base, base2; /**< indices to the base atoms of the hbond acceptor and the
                      donor atom (in base) for hydrogens */
  int octree_ptr;  /**< index (ptr) to octree leaf node to which this atoms
                      belongs */
};
