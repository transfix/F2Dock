...
#define MAX_HB_ENERGY                                                          \
  0.0 /* at and above this cutoff, not considered a hbond                      \
       */
...
#define create_poly8(name, xmin, xmax, c7, c6, c5, c4, c3, c2, c1, c0)         \
  inline void name(FLOAT x, FLOAT *value, FLOAT *deriv) {                      \
    if ((x <= xmin) || (x >= xmax)) {                                          \
      (*value) = POLY_CLIPVAL;                                                 \
      (*deriv) = 0.0;                                                          \
      return;                                                                  \
...
#define create_poly5(name, xmin, xmax, c4, c3, c2, c1, c0)                     \
  inline void name(FLOAT x, FLOAT *value, FLOAT *deriv) {                      \
    if ((x <= xmin) || (x >= xmax)) {                                          \
      (*value) = POLY_CLIPVAL;                                                 \
      (*deriv) = 0.0;                                                          \
...
#define create_poly4(name, xmin, xmax, c3, c2, c1, c0)                         \
  inline void name(FLOAT x, FLOAT *value, FLOAT *deriv) {                      \
    if ((x <= xmin) || (x >= xmax)) {                                          \
      (*value) = POLY_CLIPVAL;                                                 \
      (*deriv) = 0.0;                                                          \
...
#define create_poly3(name, xmin, xmax, c2, c1, c0)                             \
  inline void name(FLOAT x, FLOAT *value, FLOAT *deriv) {                      \
    if ((x <= xmin) || (x >= xmax)) {                                          \
      (*value) = POLY_CLIPVAL;                                                 \
      (*deriv) = 0.0;                                                          \
...
#define create_poly2(name, xmin, xmax, c1, c0)                                 \
  inline void name(FLOAT x, FLOAT *value, FLOAT *deriv) {                      \
    if ((x <= xmin) || (x >= xmax)) {                                          \
      (*value) = POLY_CLIPVAL;                                                 \
      (*deriv) = 0.0;                                                          \
...
create_poly8(POLY_AHdisBBHelix, 1.78218633,
             2.6757, // these are the roots to eliminate positive values.
             12.93768086, -221.0155722, 1604.391304, -6409.335773, 15200.86425,
             -21375.00216, 16475.98811,
             -5361.55644) create_poly8(POLY_AHdisBBOther, 1.6971523,
                                       2.679339, // non-positive interval
                                       13.58980244, -224.0452428, 1568.933094,
                                       -6044.257847, 13820.1498, -18730.96076,
                                       13912.92238, -4361.995425)
    create_poly5(POLY_AHdisSP2, 1.6941, 2.5, // non-positive interval
                 10.98727738, -100.2401419, 340.9733405, -511.6111233,
                 285.0061262)
        create_poly5(POLY_AHdisSP3, 1.755, 2.521385, // non-positive interval
                     7.011735538, -68.99968829, 251.820931, -403.3593133,
                     238.7378958) create_poly8(POLY_xDBBHelix, 0.3746, 1.04,
                                               223.5268153, -757.7254095,
                                               1019.593508, -689.2232431,
                                               240.1436064, -37.84119583,
                                               0.85868904, 0.278181985)
            create_poly8(POLY_xDBBOther, 0.76, 1.09, 111.9877946, -380.3066184,
                         514.7650204, -352.4092342, 124.6219703, -19.94401946,
                         0.149314979,
                         0.635771774) create_poly3(POLY_xDSP2short, 0.7071,
                                                   1.01, -0.562582503,
                                                   -0.746682668, 0.809265171)
                create_poly3(POLY_xDSP2long, 0.0, 1.01, 0.094962885,
                             -0.254313172,
                             0.0) create_poly3(POLY_xDSP3short, 0.61566, 1.01,
                                               -0.100140144, -1.139139041,
                                               0.739279186)
                    create_poly3(POLY_xDSP3long, 0.0, 1.01, 0.089380221,
                                 -0.207503776,
                                 0.0) create_poly8(POLY_xHBBHelix, 0.156, 1.03,
                                                   54.80664331, -196.8196655,
                                                   295.9418886, -232.105602,
                                                   96.99124565, -20.60918361,
                                                   1.573169816, 0.000745458)
                        create_poly8(POLY_xHBBOther, 0.61566, 1.07, 43.94483847,
                                     -144.3836033, 193.5865176, -132.4469355,
                                     47.28137288, -8.945888012, -0.227035135,
                                     0.791902995)
                                ...
                                create_poly3(POLY_xHSP2long, 0.0, 1.01,
                                    ...
                                    create_poly3(POLY_xHSP3, 0.0, 1.06,
                                        ...
                                        create_poly7(POLY_xHRing, 0.7608, 1.089,
                                                     37.744316, -117.731674,
                                                     143.0759275, -86.2258835,
                                                     26.7448175, -4.4699705,
                                                     0.6458455)

#else

create_poly8(POLY_AHdisBBHelix, MIN_R,
             2.8, // 1.78218633, 2.6757, // these are the roots to eliminate
                  // positive values.
             12.93768086, -221.0155722, 1604.391304, -6409.335773, 15200.86425,
             -21375.00216, 16475.98811, -5361.55644)
    create_poly8(
        POLY_AHdisBBOther, MIN_R,
        2.745, // 1.6971523, 2.679339, // non-positive interval
        13.58980244, -224.0452428, 1568.933094, -6044.257847, 13820.1498,
        -18730.96076, 13912.92238,
        -4361.995425) create_poly5(POLY_AHdisSP2, MIN_R,
                                   2.5, // 1.6941, 2.5, // non-positive interval
                                   10.98727738, -100.2401419, 340.9733405,
                                   -511.6111233, 285.0061262)
        create_poly5(POLY_AHdisSP3, MIN_R,
                     2.5, // 1.755, 2.521385, // non-positive interval
                     7.011735538, -68.99968829, 251.820931, -403.3593133,
                     238.7378958) create_poly8(POLY_xDBBHelix, MIN_xD,
                                               MAX_xD, // 0.3746, 1.04,
                                               223.5268153, -757.7254095,
                                               1019.593508, -689.2232431,
                                               240.1436064, -37.84119583,
            ...
            create_poly8(POLY_xDBBOther, MIN_xD, MAX_xD, // 0.76, 1.09,
                         111.9877946, -380.3066184, 514.7650204, -352.4092342,
                         124.6219703, -19.94401946, 0.149314979,
                         0.635771774) create_poly3(POLY_xDSP2short, MIN_xD,
                                                   MAX_xD, // 0.7071, 1.01,
                                                   -0.562582503, -0.746682668,
                                                   0.809265171)
                create_poly3(POLY_xDSP2long, MIN_xD, MAX_xD, // 0.0, 1.01,
                             0.094962885, -0.254313172,
                             0.0) create_poly3(POLY_xDSP3short, MIN_xD,
                                               MAX_xD, // 0.61566, 1.01,
                                               -0.100140144, -1.139139041,
                                               0.739279186)
                    create_poly3(POLY_xDSP3long, MIN_xD, MAX_xD, // 0.0, 1.01,
                                 0.089380221, -0.207503776,
                                 0.0) create_poly8(POLY_xHBBHelix, MIN_xH,
                                                   MAX_xH, // 0.156, 1.03,
                                                   54.80664331, -196.8196655,
                                                   295.9418886, -232.105602,
                                                   96.99124565, -20.60918361,
                                                   1.573169816, 0.000745458)
                        create_poly8(POLY_xHBBOther, MIN_xH,
                                     MAX_xH, // 0.61566, 1.07,
                                     43.94483847, -144.3836033, 193.5865176,
                                     -132.4469355, 47.28137288, -8.945888012,
                                     -0.227035135, 0.791902995)
                            create_poly3(POLY_xHSP2short, MIN_xH,
                                         MAX_xH, // 0.0, 1.08,
                                         1.720984644, -1.855254573, 0.0)
                                create_poly3(POLY_xHSP2long, MIN_xH,
                                             MAX_xH, // 0.0, 1.01,
                                             0.439598249, -0.444673076, 0.0)
                                    create_poly3(POLY_xHSP3, MIN_xH,
                                                 MAX_xH, // 0.0, 1.06,
                                                 1.761487842, -1.876959406, 0.0)
                                        create_poly7(POLY_xHRing, MIN_xH,
                                                     MAX_xH, // 0.7608, 1.089,
                                                     37.744316, -117.731674,
                                                     143.0759275, -86.2258835,
                                                     26.7448175, -4.4699705,
...
#define create_fade_interval(name, min0, fmin, fmax, max0)                     \
  inline void name##_value_deriv(FLOAT x, FLOAT *val, FLOAT *deriv) {          \
    const FLOAT name##_dfade_min =                                             \
        (fmin == min0) ? 0.0 : (1.0 / (fmin - min0)),                          \
                name##_dfade_max =                                             \
                    (max0 == fmax) ? 0.0 : (1.0 / (max0 - fmax));              \
    if (x < fmax) {                                                            \
      if (x >= fmin) {                                                         \
        *val = 1.0;                                                            \
        *deriv = 0.0;                                                          \
      ...
      *deriv = name##_dfade_min;                                               \
      *val = (x - min0) * name##_dfade_min;                                    \
    } else {                                                                   \
      if (x >= max0) {                                                         \
        *val = *deriv = 0.0;                                                   \
        return;                                                                \
      }                                                                        \
      *deriv = -name##_dfade_max;                                              \
      *val = (max0 - x) * name##_dfade_max;                                    \
    }                                                                          \
  }
    //
    // FOLLOWING ROSETTA -- FOLLOWING ROSETTA -- FOLLOWING ROSETTA -- FOLLOWING
    ...
    create_fade_interval(fade_rBB, MIN_R, MIN_R /*+ 0.1*/, R_INTERP_EDGE, MAX_R)
        ...
        create_fade_interval(fade_rshort, MIN_R, MIN_R /*+ 0.1*/, INTERP_MIN,
                             INTERP_MAX)
            create_fade_interval(fade_rlong, INTERP_MIN, INTERP_MAX, INTERP_MAX,
                                 MAX_R)
...
#define create_log_fade_interval(name, a, b, c, d, e, f)                       \
  inline void name##_log_value_deriv(FLOAT x, FLOAT *val, FLOAT *deriv) {      \
    ...
    *deriv =                                                                   \
        ((((5 * f * lnx + 4 * e) * lnx + 3 * d) * lnx + 2 * c) * lnx + b) / x; \
  }
#else
#define create_log_fade_interval(name, a, b, c, d, e, f)                       \
  inline void name##_log_value_deriv(FLOAT x, FLOAT *val, FLOAT *deriv) {      \
    ...
    *deriv =                                                                   \
    ...
    create_log_fade_interval(fade_rBB, -37.3180547817287, 285.741141861363,
                             -834.307606917721, 1189.6798830102,
                             -826.409671561707, 222.919001825369)

        create_log_fade_interval(fade_rshort, 5.17967058862565,
                                 -73.0669137757406, 315.57016260663,
                                 -559.689100793323, 438.586611628675,
                                 -126.548509998553)
            create_log_fade_interval(fade_rlong, -14.0813542571684,
                                     130.05181593123, -453.153559518528,
                                     740.025843886255, -562.47374254511,
                                     160.168566150279)

    // xD=theta should fade r,xH sooner!
    create_log_fade_interval(fade_xD, 0.133459218358311, 13.0816902916604,
                             -57.2491258523768, 86.8476548565786,
                             -3.78050184877689, -58.7848249871094)

    // fades r,xD
    create_log_fade_interval(fade_xH, 0.133459218358311, 13.0816902916604,
                             -57.2491258523768, 86.8476548565786,
                             -3.78050184877689, -58.7848249871094)
        ...
        enum HBondProp {
          ...
          HBOND_DONOR = 1,
          HBOND_ACCEPTOR = 2,
          DONATABLE_HYDROGEN = 4,
          ROTATABLE_HYDROGEN = 8,
          FIXED_HYDROGEN = 16
        };
...
// donor classes
enum HBDonChemType { hbdon_NO = 0, hbdon_BB, hbdon_SC, hbdon_MAX };
