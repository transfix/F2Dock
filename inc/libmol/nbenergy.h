...
void excl_dims(int natoms, int *na01, int **pna01, int n02, int *list02,
               int n03, int *list03, int *nd1, int *nd2, int *ndm, int *atmind);
...
// void vdweng_octree_single_mol( OCTREE *octree_static, int node_static, OCTREE
// *octree_moving, int node_moving,
//                                void *params, double dist_cutoff, double
//                                *trans_mat, double *energy );

void vdweng_octree_single_mol(OCTREE_PARAMS *octpar, double *energy);

// void eleng_octree_single_mol( OCTREE *octree_static, int node_static, OCTREE
// *octree_moving, int node_moving,
//                               void *params, double dist_cutoff, double
//                               *trans_mat, double *energy );
