#ifndef LIBICP__KDTREE_HPP
#define LIBICP__KDTREE_HPP
...
public:
  void n_nearest_brute_force(std::vector<float> &qv, int nn,
...
private:
  ...
  // Note: This code didn't exist in the repo. So I've just made it a stub.
